...
async def handle_list_tools() -> list[types.Tool]:
    ...
    return [
        types.Tool(
            name="consultar-ocr",
            description="Consultar a analise do produto OCR com uma chave na API da Acertpix",
            inputSchema={
                "type": "object",
                "properties": {
                    "chave": {"type": "string"},
        ...
        case "consultar-ocr":
            ...
            try:
                ...
                return [
                    types.TextContent(
                    type="text",
                    text=f"Resultado da consulta de analise OCR para chave {chave}:\n{resultado}"
                )    
               ]
                ...
                return [
                    types.TextContent(
                    type="text",
                    text=f"Erro ao consultar analise OCR: {str(e)}\nURL: {API_BASE_URL}"
                )
            ]
